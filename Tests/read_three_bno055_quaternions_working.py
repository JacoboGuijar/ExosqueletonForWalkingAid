...
def main():
    ...
    try:
        ...
        # Continuous reading
        print("\n" + "=" * 70)
        print("Reading quaternion data from all three sensors (Press Ctrl+C to stop)")
        print("=" * 70)
        print(f"\n{'Time':>6} | {'Sensor 1 Quaternion (w, x, y, z)':^40} | "
              f"{'Sensor 2 Quaternion (w, x, y, z)':^40} | "
              f"{'Sensor 3 Quaternion (w, x, y, z)':^40}")
        print("-" * 130)
        ...
        while True:
            ...
            print(f"{elapsed:6.1f} | "
                  f"{w1:6.3f}, {x1:6.3f}, {y1:6.3f}, {z1:6.3f} | "
                  f"{w2:6.3f}, {x2:6.3f}, {y2:6.3f}, {z2:6.3f} | "
                  f"{w3:6.3f}, {x3:6.3f}, {y3:6.3f}, {z3:6.3f}")
